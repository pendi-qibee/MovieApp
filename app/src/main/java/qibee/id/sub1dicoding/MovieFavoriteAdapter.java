...
import qibee.id.sub1dicoding.databinding.MovieFavoriteListBinding;
...
public class MovieFavoriteAdapter extends RecyclerView.Adapter<MovieFavoriteAdapter.Holder> {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        MovieFavoriteListBinding viewBinding = DataBindingUtil.inflate(mInflater, R.layout.movie_favorite_list, viewGroup, false);
